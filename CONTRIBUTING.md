...
issue](https://github.com/cisagov/ansible-role-vnc-server/issues) in
...
request](https://github.com/cisagov/ansible-role-vnc-server/pulls), you
...
```console
cd ansible-role-vnc-server
pyenv virtualenv <python_version_to_use> ansible-role-vnc-server
pyenv local ansible-role-vnc-server
