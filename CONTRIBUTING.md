...
issue](https://github.com/cisagov/ansible-role-xfce-cool/issues) in
...
request](https://github.com/cisagov/ansible-role-xfce-cool/pulls), you
...
```console
cd ansible-role-xfce-cool
pyenv virtualenv <python_version_to_use> ansible-role-xfce-cool
pyenv local ansible-role-xfce-cool
